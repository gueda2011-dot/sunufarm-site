        ...
        <div className="text-white">
          ...
          <div className="mt-6 flex flex-col gap-3 sm:flex-row">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-xl bg-white px-5 py-3 text-center text-sm font-semibold text-green-800 transition-colors hover:bg-green-50"
            >
              Parler sur WhatsApp
            </a>
            <a
              href="#pricing"
              className="rounded-xl border border-white/20 px-5 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-white/10"
            >
              Revoir les tarifs
            </a>
          </div>
